    ...
    <div class="container">
        <div class="section-title text-left">
            ...
            <p class="lead">Quisque eget nisl id nulla sagittis auctor quis id. Aliquam quis vehicula enim, non
                aliquam risus.<br> Sed a tellus quis mi rhoncus dignissim.</p>
        </div><!-- end title -->

        <div class="row">
            <div class="col-md-5">
                <div class="issuse-wrap2 clearfix">
                    <img src="assets/uploads/about_04.jpg" alt="" class="img-responsive img-rounded">
                    ...
                    <p>Tiam sit amet lacus vitae massa sodales aliquam at eget quam. Integer ultricies et magna
                        quis.</p>
                </div><!-- end issue -->
            </div><!-- end col -->
            <div class="col-md-7">
                <div class="issuse-wrap clearfix">
                    <img src="assets/uploads/issue_01.jpg" alt="" class="img-responsive img-rounded alignleft">
                ...
                <div class="issuse-wrap clearfix">
                    <img src="assets/uploads/issue_02.jpg" alt="" class="img-responsive img-rounded alignleft">
                ...
                <div class="issuse-wrap clearfix">
                    <img src="assets/uploads/issue_03.jpg" alt="" class="img-responsive img-rounded alignleft">
                ...
                <div class="issuse-wrap lastchild clearfix">
                    <img src="assets/uploads/issue_04.jpg" alt="" class="img-responsive img-rounded alignleft">
                    <h4>HEALTH CARE</h4>
                    <p>Etiam materials ut mollis tellus, vel posuere nulla. Etiam sit amet lacus vitae massa sodales
                        aliquam at eget quam. Integer ultricies et magna quis.</p>
                </div><!-- end issue -->
