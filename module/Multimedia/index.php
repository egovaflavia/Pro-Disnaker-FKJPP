    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="issuse-wrap2 clearfix">
                    <div class="post-media wow fadeIn">
                        <img src="assets/uploads/news_01.jpg" alt="" class="img-responsive img-rounded">
            ...
            <div class="col-md-4">
                <div class="issuse-wrap2 clearfix">
                    <div class="post-media wow fadeIn">
                        <img src="assets/uploads/news_02.jpg" alt="" class="img-responsive img-rounded">
                        <a href="http://www.youtube.com/watch?v=nrJtHemSPW4" data-rel="prettyPhoto[gal]" class="playbutton"><i class="flaticon-play-button"></i></a>
                    </div><!-- end media -->
            ...
            <div class="col-md-4">
                <div class="issuse-wrap2 clearfix">
                    <div class="post-media wow fadeIn">
                        <img src="assets/uploads/news_03.jpg" alt="" class="img-responsive img-rounded">
                        <a href="http://www.youtube.com/watch?v=nrJtHemSPW4" data-rel="prettyPhoto[gal]" class="playbutton"><i class="flaticon-play-button"></i></a>
                    </div><!-- end media -->
